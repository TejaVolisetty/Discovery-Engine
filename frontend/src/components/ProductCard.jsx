...
export function getProductImage(article) {
  ...
  const list = categoryImages[cat] || categoryImages['Tops'];
    ...
    >
      ...
      <div className="relative aspect-[3/4] w-full overflow-hidden bg-slate-950">
        ...
        <div className="absolute top-3 left-3 z-10">
          <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-slate-950/80 backdrop-blur-md text-indigo-300 border border-indigo-500/30 shadow-md">
      ...
      <div className="p-4 flex flex-col justify-between flex-grow">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1 line-clamp-1">{article.department || article.category}</p>
        </div>
